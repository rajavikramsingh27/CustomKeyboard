...
struct KBColors {
    ...
    init(colorScheme: KBColorScheme) {
        ...
        case .light:
            ...
            backgroundColor = UIColor.red//UIColor(red: 210/255, green: 213/255, blue: 219/255, alpha: 1.0)
            previewTextColor = .white
            previewBackgroundColor = UIColor.red//UIColor(red: 186/255, green: 191/255, blue: 200/255, alpha: 1.0)
        case .dark:
            ...
            backgroundColor = UIColor.red//UIColor(white:89/255, alpha: 1.0)
            previewTextColor = .white
            previewBackgroundColor = UIColor.red//UIColor(white: 80/255, alpha: 1.0)
        }
    }
...
let containerPrimaryViewColor = UIColor.red//UIColor.white
